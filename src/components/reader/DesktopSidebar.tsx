...
const DesktopSidebar = ({
  ...
  return (
    <div
      className="hidden md:flex fixed top-0 right-0 bottom-0 z-40 bg-reader-surface border-l border-reader-border"
      style={{
    ...
    >
      {/* Icon rail */}
      <div className="w-14 shrink-0 flex flex-col items-center pt-16 gap-1 border-r border-reader-border">
      ...
      {isExpanded && (
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          {/* Header */}
          <div className="h-14 flex items-center justify-between px-4 border-b border-reader-border shrink-0 mt-[52px]">
